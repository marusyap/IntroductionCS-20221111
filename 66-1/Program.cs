// 66. Написать подпрограмму, которая в квадратной матрице чисел находит
...
int SumSecondaryDiagonal(int[,] a)
{
    int s=0;
...
try
{
    System.Console.WriteLine($"Сумма элементов побочной диагонали {SumSecondaryDiagonal(a)}");
}
catch(Exception ex)
{
